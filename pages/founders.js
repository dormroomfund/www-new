          ...
          <div className="founders-hero-wrapper">
            ...
            <div className="founders-hero-grid">
              <div className="left-part">
                <div className="left-first-row">
                  <div className="left-first-row-first-half tile">
                    <Link href="/muneeb-ali">
                      <a>
                        <img className="tile-img" src="/static/img/founders_compressed/blockstack2.jpg"></img>
                  ...
                  <div className="left-first-row-second-half tile">
                    <Link href="/chris-gray">
                      <a>
                        <img className="tile-img" src="/static/img/founders_compressed/scholly.jpg"></img>
                        <div className="overlay-text card-text">
                ...
                <div className="left-second-row tile">
                  <Link href="/brooklinen">
                    <a>
                      <img className="tile-img brooklinen" src="/static/img/founders_compressed/brooklinen.jpg"></img>
                      <div className="overlay-text card-text">
              ...
              <div className="right-part tile">
                <Link href="/tim-hwang">
                  <a>
                    <img className="tile-img fiscalnote" src="/static/img/founders_compressed/fiscalnote.jpg"></img>
                    <div className="overlay-text card-text">
