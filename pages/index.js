          ...
          <div className="value-section-cards content">
            <div className="col-4 m-col-12">
              <div className="value-section-card">
                <h3>Community</h3>
                <p className="value-section-text">300+ fellow founders, 50+ mentors, dozens of intimate events with industry leaders and investors.</p>
              </div>
            </div>
            <div className="col-4 m-col-12">
              <div className="value-section-card">
                <h3>Mentors</h3>
                <p className="value-section-text">Access to world-class advisors, including the founders of Buzzfeed, Venmo, YouTube, and Quora.</p>
              </div>
            </div>
            <div className="col-4 m-col-12">
              <div className="value-section-card">
        ...
        <div className="content">
          <div className="founders-wrapper">
            <div>
              ...
              <Link href="/founders"><a className="colored-section-button button-rounded-white">Our Founders</a></Link>
            </div>
          </div>
          <div className="founders-image-container">
            <img className="founders-image" src="/static/img/founders_compressed/blockstack1.jpg"></img>
        ...
        <div className="content">
          <div className="community-wrapper">
            <div>
              ...
              <Link href="/team"><a className="colored-section-button button-rounded-white">Our Team</a></Link>
            </div>
          </div>
          <img className="community-image" src="/static/img/community-photo.jpg"></img>
        </div>
      </div>
    )
  }
                    ...
                    <div className="col-10 col-centered m-col-12">
                      <div className="content">
                        <div className="col-3 m-col-6">
                          <object className="logo" data="/static/img/investor-firstround.svg" type="image/svg+xml"></object>
                        </div>
                        <div className="col-3 m-col-6">
                          <object className="logo" data="/static/img/investor-gv.svg" type="image/svg+xml"></object>
                        </div>
                        <div className="col-3 m-col-6">
                          <object className="logo" data="/static/img/investor-sequoia.svg"></object>
                        </div>
                        <div className="col-3 m-col-6">
                          <object className="logo" data="/static/img/investor-yc.svg" type="image/svg+xml"></object>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="content">
                <div className="col-4 m-col-12">
                  <a target="_blank" href="https://medium.com/@dormroomfund/drf4life-congrats-to-the-graduating-dorm-room-fund-partners-719f82ab3e03">
                    <div className="medium-card">
                      <img className="medium-article" src="/static/img/article-2.jpg"></img>
                ...
                <div className="col-4 m-col-12">
                  <a target="_blank" href="https://medium.com/@dormroomfund/meet-the-seven-dorm-room-fund-startups-presenting-at-y-combinator-s17-demo-day-e6e731851726">
                    <div className="medium-card">
                      <img className="medium-article" src="/static/img/article-1.jpg"></img>
                ...
                <div className="col-4 m-col-12">
                  <a target="_blank" href="https://medium.com/@dormroomfund/the-26-students-powering-entrepreneurship-meet-dorm-room-funds-new-partners-2a2d83d7c9f0">
                    <div className="medium-card last">
                      <img className="medium-article" src="/static/img/article-3.jpg"></img>
      ...
      <form className="resources-section-form">
        { !this.state.submitted ?
          <div>
            ...
            <div className={ "validation-message" + (this.state.error ? "" : "hidden") }>
              <p>
                { this.state.message }
              </p>
            </div>
