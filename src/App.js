            ...
            <div className="col-4 m-col-12">
              ...
              <div className="sidebar">
                <ul className="overview-list">
                  <li>Milestones</li>
                  { this.props.milestones.map((milestone) => <li>
                                                               { milestone }
                                                             </li>) }
                </ul>
                <ul className="overview-list">
                  <li>Founders</li>
                  { this.props.founders.map((milestone) => <li>
                                                             { milestone }
                                                           </li>) }
                </ul>
              </div>
                ...
                <div className="feature-bio">
                  <p>
                    { this.props.bio.split("\n").map(i => {
                        return <div className="bio-line-break">
                                 { i }
                               </div>;
                      }) }
                  </p>
          ...
          <div className="content">
            <div className="col-12">
              <div className="logos-wrapper">
                <h1>We&#39;ve invested in 150 startups whove raised $400 million from:</h1>
                <div className="logos">
                  <div className="content">
                    <div className="col-10 col-centered m-col-12">
                      <div className="content">
                        <div className="col-3 m-col-6">
                          <object className="logo" data={ investor_firstround } type="image/svg+xml"></object>
                        </div>
                        <div className="col-3 m-col-6">
                          <object className="logo" data={ investor_gv } type="image/svg+xml"></object>
                        </div>
                        <div className="col-3 m-col-6">
                          <object className="logo" data={ investor_sequoia }></object>
                        </div>
                        <div className="col-3 m-col-6">
                          <object className="logo" data={ investor_yc } type="image/svg+xml"></object>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <ul className="links">
                ...
                <li>
                  <a className="menu" href="https://twitter.com/DormRoomFund">
                    <div className="link-box"><img className="icon" src={ twitter_icon }></img><span className="link-text">Twitter</span></div>
                  </a>
                </li>
              </ul>
            </div>
