      ...
      <div className="mobile-nav">
        <div className="mobile-wrapper">
          <div>
            <ul>
              <li>
                <Link href="/founders"><a className="menu menu-link">Our Founders</a></Link>
              </li>
              <li>
                <Link href="/team"><a className="menu menu-link">Our Team</a></Link>
              </li>
  ...
  render() {
    ...
    return (
      <div>
        ...
        <nav style={style} className={ this.state.showMobileMenu ? "mobile-menu-visible" : "" }>
          <div className="content">
            <div className="wrapper">
              <div className={ "logo-container " + (this.state.showMobileMenu ? "mobile-menu-visible" : "") }>
                { this.props.lightColor ?
                  <div>
                    <Link prefetch href="/"><a><img alt="Dorm Room Fund logo" className="drf-logo-white" src="/static/img/drf-logo-white.svg"></img></a></Link>
                    <Link prefetch href="/"><a><img alt="Dorm Room Fund logo" className="drf-logo-small-white" src="/static/img/drf-logo-small-white.svg"></img></a></Link>
                  </div>
                  :
                  <div>
                    <Link prefetch href="/"><a><img alt="Dorm Room Fund logo" className="drf-logo-black" src="/static/img/drf-logo-black.svg"></img></a></Link>
                    <Link prefetch href="/"><a><img alt="Dorm Room Fund logo" className="drf-logo-small-black" src="/static/img/drf-logo-small-black.svg"></img></a></Link>
                  </div> }
              </div>
              <ul className={ "links " + (this.state.showMobileMenu ? "lock" : "") }>
                ...
                <li>
                  <Link prefetch href="/founders"><a className={ "menu " + (this.props.lightColor ? 'light' : '') }>Our Founders</a></Link>
                </li>
                <li>
                  <Link prefetch href="/team"><a className={ "menu " + (this.props.lightColor ? 'light' : '') }>Our Team</a></Link>
                </li>
                <li>
